...
const MasterKey = crypto.createHash('sha256').update('🧬🌐『 𝖭𝖬𝖣 𝖠𝖷𝖨𝖲 』🌐🧬_Ultra_Secret_Encryption_2024_Nimesha_Madhushan_Secure_Config').digest();
const EncryptionIV = crypto.createHash('md5').update('NMD_AXIS_Bot_IV').digest();
...
const EncryptedDatabase = {
	...
	s3: EncryptData('🧬🌐『 𝖭𝖬𝖣 𝖠𝖷𝖨𝖲 』🌐🧬'),
	s4: EncryptData('https://github.com/nima-axis/nmd-axis.git'),
	s5: EncryptData('> *🧬🌐『 𝖭𝖬𝖣 𝖠𝖷𝖨𝖲 』🌐🧬* [BOT]✨ | 👑 _CREATED BY *NIMESHA MADHUSHAN*_ '),
	...
	h3: crypto.createHash('sha256').update(EncryptData('🧬🌐『 𝖭𝖬𝖣 𝖠𝖷𝖨𝖲 』🌐🧬')).digest('hex'),
	h4: crypto.createHash('sha256').update(EncryptData('https://github.com/nima-axis/nmd-axis.git')).digest('hex'),
	h5: crypto.createHash('sha256').update(EncryptData('> *🧬🌐『 𝖭𝖬𝖣 𝖠𝖷𝖨𝖲 』🌐🧬* [BOT]✨ | 👑 _CREATED BY *NIMESHA MADHUSHAN*_ ')).digest('hex'),
